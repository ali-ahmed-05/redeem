...
async function main() {
  ...
  console.log(
    ...
    doseVoucherRedeemer = await DoseVoucherRedeemer.deploy(tokenLaunchpadVouchers.address,stz_address,await deployer.getAddress())
  ...
  saveFrontendFiles(tokenLaunchpadVouchers,doseVoucherRedeemer)
...
function saveFrontendFiles(nFT) {
  ...
  let config = `
 export const doseVoucherRedeemer_addr = "${doseVoucherRedeemer.address}"
 export const tokenLaunchpadVouchers_addr = "${tokenLaunchpadVouchers.address}"
`
